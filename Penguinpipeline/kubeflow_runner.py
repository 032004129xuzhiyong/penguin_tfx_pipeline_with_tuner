...
OUTPUT_DIR = os.path.join(configs.PVM,configs.PROJECTNAME)
PIPELINE_ROOT = os.path.join(OUTPUT_DIR,configs.PIPELINE_NAME)
SERVING_MODEL_DIR = os.path.join(PIPELINE_ROOT,'serving_model')
...
def run():
  ...
  pipeline_operator_funcs = [onprem.mount_pvc(configs.PVC,configs.PV,configs.PVM)]
