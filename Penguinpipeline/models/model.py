...
from models.tuner import MyHyperModel
...
def run_fn(fn_args: tfx.components.FnArgs):
  ...
  with mirrored_strategy.scope():
    if fn_args.hyperparameters is None:
      model = _build_keras_model(feature_list,constants.NUM_LAYERS,'relu')
    else:
      model = MyHyperModel(feature_list).build(keras_tuner.HyperParameters.from_config(fn_args.hyperparameters))
