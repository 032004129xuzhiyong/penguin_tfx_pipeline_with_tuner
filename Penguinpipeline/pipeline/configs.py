...
#This is for pvc to provide directory to things that contains data_dir/module_path/output_dir
PVC = 'data-pvc'
PV = 'data-pv'
PVM = '/tfx-data'
PROJECTNAME = 'templatepipeline'
...
PIPELINE_IMAGE = 'tensorflow/tfx:1.14.0.dev20230619'


CUSTOM_ARGO_WORKFLOW_IMAGE = 'gcr.m.daocloud.io/ml-pipeline/argoexec:v3.3.8-license-compliance'


PREPROCESSING_FN = 'models.preprocessing.preprocessing_fn'
RUN_FN = 'models.model.run_fn'
TUNER_FN = 'models.tuner.tuner_fn'
